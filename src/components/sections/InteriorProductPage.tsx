 ...
 * downloads, gallery, FAQ and "other models" are static, so they are
 * rendered on the server (src/components/product/*) and passed in as slots;
 * this client component only owns the hero, the colour configurator and the
 * sticky navigation.
 */
