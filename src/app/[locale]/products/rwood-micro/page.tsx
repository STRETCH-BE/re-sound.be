...
export default async function Page({ params: { locale } }: PageProps) {
  ...
  // Product FAQ (messages) + the workbook rows tagged "rwood-micro", without duplicates
  const faqEntries: FaqEntry[] = mergeFaqEntries(
    ...
    (await faqForResolved(locale, 'rwood-micro')).map((f) => ({ question: f.question, answer: f.answer }))
  );
