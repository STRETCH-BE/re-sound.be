...
export default async function Page({ params: { locale } }: PageProps) {
  ...
  const galleryImages = GALLERY_IMAGES.map((src, i) => ({
    src,
    alt: `rWood Micro micro-perforated acoustic wood panels — project installation ${i + 1}`,
  }));
    ...
    <NextIntlClientProvider locale={locale} messages={messages}>
      <JsonLd
        data={productSchema({
          ...
          countryOfOrigin: PRODUCTS['rwood-micro'].madeIn ?? undefined,
      ...
      <RWoodMicroProductPage
        ...
        otherModels={<OtherModels slug="rwood-micro" />}
      />
