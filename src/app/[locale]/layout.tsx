...
// Syne is the heading face; every heading weight in globals.css and the
// styled-jsx blocks is 600-800, so 400/500 are not loaded.
const syne = Syne({
  subsets: ['latin'],
  weight: ['600', '700', '800'],
  variable: '--font-syne',
  ...
  return (
    <html lang={htmlLang} className={`${syne.variable} ${dmSans.variable}`}>
      <head>
        ...
        {/* gtag.js loads on every page (Consent Mode gates tracking), so
            warming the connection saves a DNS+TLS round trip. */}
