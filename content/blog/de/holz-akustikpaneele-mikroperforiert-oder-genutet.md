...
Ein Besprechungsraum von 5 × 4 m bei 2,8 m Höhe hat **56 m³**. Teppichfliesen, sechs gepolsterte Stühle, eine Glaswand; gemessene Nachhallzeit **0,9 s**. DIN 18041 (Hörsamkeit in Räumen) ordnet Besprechungsräume der Kategorie A3 „Unterricht/Kommunikation“ zu und gibt dafür die Soll-Nachhallzeit T_soll = 0,32 · lg(V) − 0,17 s vor; für Büros ergänzen VDI 2569 und ISO 22955 die Planungsgrundlage.

- T_soll = 0,32 × lg(56) − 0,17 = 0,32 × 1,75 − 0,17 = 0,56 − 0,17 = **0,39 s**
...
**Genutet** bedeutet sichtbaren Rhythmus. Die Nuten gliedern die Wand in Linien und lesen sich schon aus der Ferne als Akustikwand. In Empfangsbereichen, Restaurants und Besprechungsräumen ist das der Klassiker.

**Mikroperforiert** bedeutet Ruhe. Aus zwei Metern Abstand wirkt rWood Micro wie eine geschlossene Furnierfläche; erst aus der Nähe erkennt man die Perforation. Das ist die Wahl für Räume, in denen das Holz als Fläche wirken soll – Vorstandsetagen, Kanzleien, Aulen, Hörsäle – oder wenn die Akustikpaneele bündig mit Türen und Einbauschränken laufen sollen.

Bei beiden Reihen verwenden wir **ausschließlich FSC-zertifizierte Furniere**; das Lagerprogramm deckt die gängigen Hölzer ab, Furniere außerhalb des Programms fertigen wir auf Anfrage. Und oft ist die Antwort nicht entweder-oder: genutet an der Wand, die den Raum prägt, mikroperforiert an den Flächen, die zurücktreten sollen.
...
## Entscheidungstabelle: wann genutet, wann mikroperforiert
