...
description: "Was kostet eine Telefonbox fürs Büro? Solo Flex ab 2.740 € zzgl. MwSt. Dazu ISO-23351-1-Klassen, Lüftung, Aufstellung und Lieferzeit – vom Hersteller."
...
Im September 2026 kostet eine Einpersonen-Telefonzelle fürs Büro zwischen rund 2.700 € und mehr als 9.000 € zzgl. MwSt.:
...
Zur Standardausstattung von Solo Flex gehören:

- **Lüftung mit vier EC-Ventilatoren**, 4,6 m³ Luft pro Minute, gesteuert über einen Bewegungsmelder.
- **230-V-Steckdose und USB-C-Anschluss** in der Kabine.
...
Nicht im Preis ohne Montage: Transport bis auf die Etage und Aufbau. Zwei Personen bauen die Kabine in unter drei Stunden selbst auf, oder Sie wählen den Preis inklusive Montage (865 € Unterschied): Unser Team braucht dafür rund eine Stunde. Ein rollstuhlgerechter Zugang ist bei keiner Kabine Standard, lässt sich aber auf Anfrage umsetzen.

## Welche Größe: 1, 2 oder 6 bis 10 Personen

Die richtige Größe der [Telefonbox](/de/products/telefonboxen) folgt aus dem, was auf der Fläche schiefläuft: Zählen Sie eine Woche lang, wie viele Kollegen zur Stoßzeit gleichzeitig telefonieren.

**Eine Person (Solo Flex, 1 m²).** Für Telefonate, Videokonferenzen und konzentriertes Arbeiten. Grundfläche 1.020 × 1.020 mm, Höhe 2.260 mm, 280 kg.

**Zwei Personen (Duo, 2 m²).** Für das Gespräch unter vier Augen oder zwei Kollegen in einer gemeinsamen Videokonferenz. Mit 230-V-Anschluss und elektrisch höhenverstellbarem Tisch; ein Messwert nach ISO 23351-1 liegt noch nicht vor.

**Sechs bis zehn Personen (Modular XL).** Ein Besprechungsraum als Raum-in-Raum-System: sechs bis zehn Personen standardmäßig, erweiterbar in 90-cm-Elementen, mit vollständiger Audio- und Video-Vorrüstung; der größte bisher gebaute bietet zwanzig Personen Platz.

## Akustik: Was die Klassen nach ISO 23351-1 bedeuten

Die entscheidende Zahl einer Akustikkabine ist die **Sprachpegelminderung nach ISO 23351-1** in dB(A): um wie viel leiser Sprache von innen nach außen wird. Die Norm teilt Kabinen in Klassen ein:

| Klasse | Sprachpegelminderung | In der Praxis |
|---|---|---|
| A+ | ≥ 33 dB | ein Gespräch ist außerhalb der Kabine nicht mehr hörbar |
| A | ≥ 30 dB | kaum hörbar |
| B | ≥ 27 dB | gedämpftes Murmeln, nicht verständlich |
| C | ≥ 24 dB | fernes Murmeln, nicht verständlich |
| D | ≥ 21 dB | hörbar, Wortfetzen verständlich |

**Solo Flex erreicht rund 24 dB(A), also Klasse C; Modular XL erreicht 25,9 dB(A), ebenfalls Klasse C.** Für Telefonate und Videokonferenzen im offenen Büro ist das der Pegel, der das Problem löst: Ihre Kollegen hören fernes Murmeln, aber kein Wort. Für vertrauliche Besprechungen direkt neben einer stark belegten Fläche wählen Sie eine höhere Klasse oder einen geschlossenen Raum; prüfen Sie die genaue Anforderung mit Ihrem Akustiker.

Verlangen Sie von jedem Anbieter den Messbericht nach ISO 23351-1; ohne gemessene Klasse kennen Sie die Leistung nicht.

## Lüftung, Licht und Strom

Nach der Akustik entscheidet die Lüftung, ob eine Kabine genutzt wird: Eine schlecht belüftete Kabine heizt sich auf, die Tür bleibt offen, die Investition ist verloren. Jede Re-Sound-Kabine ist belüftet; die elektrischen Modelle nutzen ein leises EC-Ventilatorsystem.

- **Luftwechsel**: Nach Außenmaßen fasst Solo Flex 1,02 × 1,02 × 2,26 = 2,35 m³; bei 4,6 m³/min ist diese Luft nach 2,35 / 4,6 = 0,51 Minuten ausgetauscht, also rund alle 30 Sekunden.
- **Steuerung**: Der Bewegungsmelder schaltet Lüftung und LED-Beleuchtung beim Betreten ein.
- **Strom**: 230 V und USB-C in der Kabine – Laptop und Telefon laden ohne Kabel nach draußen.

## Aufstellung: sechs Prüfpunkte vor der Bestellung

1. **Höhe**: 2.260 mm bei Solo Flex; planen Sie Spielraum unter Decken, Sprinklern und Leuchten ein.
2. **Grundfläche und Tür**: 1.020 × 1.020 mm plus Platz zum Öffnen der Tür und zum Vorbeigehen.
3. **Bodenlast**: 280 kg auf 1 m². Bei einem Doppelboden melden Sie das vorab an.
4. **Steckdose**: Eine gewöhnliche Steckdose in Kabelreichweite genügt; die Kabine steht frei, ohne baulichen Eingriff.
5. **Standort**: Nicht neben der Kaffeeküche oder auf einem Laufweg, sondern nah bei den Kollegen, die am meisten telefonieren.
6. **Umzug**: Vor Ort montiert, später zerlegbar und auf eine andere Etage oder in ein anderes Gebäude mitzunehmen.

## Telefonbox oder Akustikpaneele? Ein Rechenbeispiel

Eine Telefonbox löst das Problem einer sprechenden Person, nicht den Nachhall der ganzen Fläche – dafür sind Akustikpaneele zuständig. Die Richtung geben VDI 2569 (Büroakustik), ISO 22955 (offene Büros) und DIN 18041 (Hörsamkeit) vor; prüfen Sie die genaue Anforderung mit Ihrem Akustiker.

Beispiel: ein offenes Büro mit 240 m² × 3 m = 720 m³, gemessene Nachhallzeit 1,2 s, Ziel 0,7 s. Sabine-Formel A = 0,161 × V / T:
...
Standardkonfigurationen liefern wir **vier bis sechs Wochen** nach Auftragsbestätigung. Die Montage übernehmen Sie selbst oder unser Team: rund eine Stunde für eine Einzelkabine, etwa zwei Stunden für einen Meeting-Pod, zwei bis sechs Stunden für Modular XL.

Am Ende der Nutzungsdauer lässt sich die Kabine weiterverkaufen oder wie ein Bausatz zerlegen; jedes Material ist recycelbar. Akustikpaneele nehmen wir in Deutschland, Belgien, den Niederlanden, Frankreich und Luxemburg kostenlos zurück.

Testen Sie die Kabinen in unserer Ausstellung in Beveren-Waas (nach Vereinbarung); Händler und Kontaktdaten unter [Wo kaufen](/de/where-to-buy). **Bereit zum Vergleichen?** Fordern Sie über die [Kontaktseite](/de/contact) ein Angebot für Solo Flex an, oder vergleichen Sie zuerst alle Modelle im [Preisleitfaden für Telefonboxen](/de/guides/telefonbox-preise).
