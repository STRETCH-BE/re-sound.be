---
id: "BP-018"
slug: "specifying-acoustic-panels-aw-nrc-class-a"
locale: "en"
title: "Acoustic panel specification for architects: αw vs NRC | Re-Sound"
description: "Acoustic panel specification for architects: αw (ISO 11654) vs NRC (ASTM C423), Class A/B/C, mounting, fire class B-s1,d0, documents and a checklist."
h1: "Specifying acoustic panels for architects: αw, NRC and Class A"
keyword: "acoustic panel specification architects"
secondaryKeywords: ["αw vs nrc","class a acoustic panels","acoustic panel specification clause","iso 11654 sound absorption class"]
intent: "learn"
category: "education"
...
## αw and NRC: two ratings for one panel

Both come from the same kind of laboratory test: a large sample in a reverberation room, sound decay measured with and without it, an absorption coefficient α per frequency band from 0 (reflects everything) to 1 (absorbs everything).

**αw (ISO 11654)** fits the measured curve from 250 Hz to 4,000 Hz to a reference curve shifted in steps of 0.05. A panel weak in one band is penalised; the result is capped at 1.00 and sorted into classes A to E.
...
ISO 11654 sorts αw into five classes:

- **Class A**: αw 0.90–1.00
...
Lab values come from a large, evenly mounted sample in a diffuse field; in a room the panels cover a fraction of the surface, so the rating is a basis for calculation, not a guarantee. Meeting room 5 × 4 m, 2.8 m high, V = 56 m³, measured at 0.9 s, target 0.6 s. Sabine's formula A = 0.161 × V / T:

- A today = 0.161 × 56 / 0.9 = **10.0 m² Sabine**
...
| Documents | Datasheet, test report, fire report, certificates, installation guide |

Send us the room schedule for datasheets, test reports and a quote per range, or start with the free sample kit. See [where to buy](/en/where-to-buy) or [contact us](/en/contact).
