---
id: "BP-office-reverberation-norm-en"
slug: "office-reverberation-time-din-18041"
locale: "en"
title: "Office reverberation time: the DIN 18041 method | Re-Sound"
description: "Office reverberation time with the German DIN 18041 method as a reference: targets by volume, two worked examples and the measures that get you there."
h1: "Office reverberation time: planning with the DIN 18041 method (worked examples)"
keyword: "office reverberation time"
secondaryKeywords: ["din 18041 office","reverberation time open-plan office","meeting room reverberation time","office acoustics standard"]
intent: "learn"
category: "education"
...
heroAlt: "Close-up of an rPET Groove acoustic panel in grey recycled PET felt with deep grooves"
internalLinks: ["/en/products/rpet-groove","/en/products/pet-acoustic-panels","/en/products/rwood-groove","/en/products/interior","/en/products/divide","/en/products/acoustic-phone-booths","/en/products/solo-flex","/en/products/duo","/en/guides/phone-booth-prices","/en/products/modular-xl","/en/contact","/en/where-to-buy","https://stretchplafond.be/products/acoustic-stretch-system","/en/blog/improve-open-plan-office-acoustics"]
cta: "Send us your floor plan and ceiling height and you will receive a first absorption calculation and a free sample kit."
...
faq: [{"question":"Which reverberation time does an office need?","answer":"Using the German DIN 18041 method as a reference, meeting and conference rooms (category A, group A3) get T = 0.32·lg(V) − 0.17 s: around 0.39 s at 56 m³, 0.57 s at 200 m³. Open-plan offices fall under category B, where the standard recommends a minimum ratio of absorption area to room volume, supplemented by VDI 2569 and ISO 22955; for UK projects BS 8233 is the pointer. Check the exact requirement with your acoustician."},{"question":"How much absorption does a 720 m³ open-plan office need?","answer":"From 1.2 s to 0.7 s by Sabine: 0.161 × 720 / 0.7 = 165.6 m² Sabine, of which 96.6 m² is already there, so 69 m² Sabine to add, for example 50 m² of class A ceiling elements and 30 m² of rPET Panel 12 mm on a 100 mm air cavity (αw 0.80, class B). That does not solve calls on the floor; plan phone booths for those."},{"question":"Does a phone booth replace the acoustic panels?","answer":"No. Panels lower the reverberation of the whole floor; a phone booth solves the problem of one person talking. Solo Flex reduces the speech level by around 24 dB(A), class C to ISO 23351-1, and costs from {{price:solo-flex}} excl. VAT without installation; Modular XL reaches 25.9 dB(A), also class C. A well-planned office needs both."}]
draft: false
...
- **Ceiling**: 50 m² of class A ceiling elements (assume αw 0.9) = 45 m² Sabine. Alternative: a seamless [acoustic stretch ceiling](https://stretchplafond.be/products/acoustic-stretch-system), which our sister company STRETCH fits in a day.
...
**4. Phone booths for calls and video meetings.** Calls on the floor disturb most; an [acoustic phone booth](/en/products/acoustic-phone-booths) deals with them. A booth like [Solo Flex](/en/products/solo-flex) needs 1 m², ventilates at 4.6 m³/min and reduces the speech level by around 24 dB(A), class C to ISO 23351-1. From {{price:solo-flex}} excl. VAT without installation; installation by our team {{price:article:WEB-SOLO-FLEX-INST}}, transport within mainland Europe {{price:article:WEB-SOLO-FLEX-TRANSPORT-EU}}, each excl. VAT; one booth per eight to ten workstations. For two people: [Duo](/en/products/duo) from {{price:duo}} excl. VAT. Compare the models in the [phone booth price guide](/en/guides/phone-booth-prices).

**5. Meeting pods.** Where meeting rooms are lacking, meetings land on the floor. [Modular XL](/en/products/modular-xl) is a room-in-room system for six to ten people, extendable in 90 cm elements, 25.9 dB(A) speech level reduction (class C), from {{price:modular-xl}} excl. VAT without installation (installation by our team {{price:article:WEB-MODULAR-XL-INST}} for the base module plus {{price:article:WEB-MODULAR-XL-INST-EXT}} per additional element; transport within mainland Europe {{price:article:WEB-MODULAR-XL-TRANSPORT-EU}}, each excl. VAT), freestanding.

The seven-step version of this list, with the agreements that keep the silence, is in [Improving the acoustics of an open-plan office](/en/blog/improve-open-plan-office-acoustics).
...
**Where does your office stand acoustically?** Send us your floor plan and ceiling height via the [contact page](/en/contact); you will receive a first absorption calculation and a free sample kit. Booths and panels stand in our showroom in Beveren-Waas; dealers under [where to buy](/en/where-to-buy).

## Frequently asked questions

**Which reverberation time does an office need?**
Using the German DIN 18041 method as a reference, meeting and conference rooms (category A, group A3) get T = 0.32·lg(V) − 0.17 s: around 0.39 s at 56 m³, 0.57 s at 200 m³. Open-plan offices fall under category B, where the standard recommends a minimum ratio of absorption area to room volume, supplemented by VDI 2569 and ISO 22955; for UK projects BS 8233 is the pointer. Check the exact requirement with your acoustician.

**How much absorption does a 720 m³ open-plan office need?**
From 1.2 s to 0.7 s by Sabine: 0.161 × 720 / 0.7 = 165.6 m² Sabine, of which 96.6 m² is already there, so 69 m² Sabine to add, for example 50 m² of class A ceiling elements and 30 m² of rPET Panel 12 mm on a 100 mm air cavity (αw 0.80, class B). That does not solve calls on the floor; plan phone booths for those.

**Does a phone booth replace the acoustic panels?**
No. Panels lower the reverberation of the whole floor; a phone booth solves the problem of one person talking. Solo Flex reduces the speech level by around 24 dB(A), class C to ISO 23351-1, and costs from {{price:solo-flex}} excl. VAT without installation; Modular XL reaches 25.9 dB(A), also class C. A well-planned office needs both.
