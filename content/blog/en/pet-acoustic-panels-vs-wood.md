---
id: "BP-016"
slug: "pet-acoustic-panels-vs-wood"
locale: "en"
title: "PET acoustic panels vs wood: which one where? | Re-Sound"
description: "PET acoustic panels vs wood: absorption, look, fire class, sustainability, workability, lead times and a decision table, from the manufacturer."
h1: "PET acoustic panels vs wood acoustic panels: which one where?"
keyword: "pet acoustic panels vs wood"
secondaryKeywords: ["pet felt acoustic panels","wood acoustic panels","acoustic panel comparison","wood veneer acoustic panel"]
intent: "compare"
category: "products"
...
**PET felt** is a dense fibre board pressed from recycled PET. Sound enters the fibres and loses its energy there as friction, so the whole panel absorbs: face, edges and back. A backing air gap improves low-frequency absorption further.
...
Often the answer is not either/or: wood on the feature wall, PET on the long walls and the ceiling.
...
## Decision table: when PET, when wood
