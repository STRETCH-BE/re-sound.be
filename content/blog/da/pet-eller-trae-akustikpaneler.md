---
id: "BP-pet-vs-wood-da"
slug: "pet-eller-trae-akustikpaneler"
locale: "da"
title: "PET eller træ: hvilket akustikpanel hvor? | Re-Sound"
description: "PET-filt eller træ som akustikpanel? Absorption, udseende, brandklasse, bæredygtighed, bearbejdning, leveringstid og en beslutningstabel fra producenten."
h1: "PET-akustikpaneler eller akustikpaneler i træ: hvad vælger du hvor?"
keyword: "pet akustikpaneler eller træ"
secondaryKeywords: ["pet filt akustikpaneler","akustikpaneler i træ","sammenligning af akustikpaneler","akustikpanel med træfinér"]
intent: "compare"
category: "products"
...
heroAlt: "rPET Groove-filtpanel i grå ved siden af et rWood Groove-panel i egefinér, nærbillede af rillerne"
...
sources: "ISO 11654 (lydabsorptionsklasser); ASTM C423 (NRC); EN 13501-1 (brandklasser); ISO 22955 som pejlemærke; DS 490 (dansk standard); W.C. Sabine (efterklangsformel); OEKO-TEX Standard 100; FSC; produktdata og testrapporter for Re-Sound rPET og rWood."
...
**PET-filt** er en tæt fiberplade presset af genanvendt PET. Lyden trænger ind mellem fibrene og mister sin energi som friktion, så hele pladen arbejder: forside, kanter og bagside. En luftspalte bag pladen forbedrer absorptionen i de lave frekvenser yderligere.
...
For rPET Groove, der skæres ud af den samme plade, findes der kun NRC-tal (0,55 ved 12 mm, 0,75 ved 24 og 0,90 ved 36 mm); regn med rPET Panel-værdierne og deres montering.
...
**PET er farve.** [rPET Groove](/da/products/rpet-groove) fås i de ti rPET-lagerfarver (enhver farve på bestilling), i 12, 24 eller 36 mm, og rPET-plader kan males eller UV-printes hos os selv med din egen grafik: en farvet væg, et logo i filten. [rPET Flex Groove](/da/products/rpet-flex-groove) følger søjler og buede vægge.

**Træ er varme.** rWood Groove og rWood Perf viser finéren gennem deres mønster; [rWood Panel](/da/products/rwood-veneer) tilbyder et udvalg af FSC-certificerede finérer; rWood Micro har en næsten lukket overflade, der læses som en glat træplade. I bestyrelseslokaler, receptioner, restauranter og auditorier vinder træ næsten altid på udstråling.

Ofte er svaret ikke enten-eller: træ på den væg, man ser, PET på de lange vægge og loftet.

## Brandsikkerhed og emissioner

I offentlige bygninger er brandklassen efter EN 13501-1 ofte et ufravigeligt krav; tjek det præcise krav med din akustiker eller brandrådgiver.

- **rPET-serien**: B-s1,d0 i hvid, grå og sort, B-s2,d0 i de øvrige farver; klassen følger farven, ens for Standard- og FR-versionen. B-s1,d0 betyder begrænset brandbidrag, lav røgudvikling og ingen brændende dråber.
- **rWood Micro og rWood Perf**: B-s1,d0 på den brandhæmmende MDF-kerne.
- **rWood Groove**: B-s1,d0 på FR-MDF-kernen, D-s2,d2 på standard-MDF, så skriv kernen ind i udbuddet.

Indeklima: rPET er OEKO-TEX Standard 100-certificeret. Til rWood arbejder vi udelukkende med FSC-certificerede finérer.

## Bæredygtighed: genanvendt over for fornybart

**rPET** begynder livet som genanvendt PET; rPET Groove er fremstillet udelukkende af genanvendt PET. Ved endt levetid tager vi panelerne tilbage uden beregning i Belgien, Nederlandene, Frankrig, Tyskland og Luxembourg; ordningen gælder ikke i Danmark, så her aftaler du bortskaffelsen lokalt.

**rWood** sætter et fornybart råmateriale på forsiden: kun FSC-certificerede finérer, ingen undtagelser. Den samme gratis tilbagetagning gælder i de samme fem lande, og heller ikke her i Danmark.

Begge serier bliver fremstillet på vores egen fabrik i Częstochowa; læs mere på siden om [bæredygtighed](/da/sustainability). Vælger du på ét tal? PET. På en naturlig, certificeret overflade? Træ.
...
**Vedligehold**: PET støvsuges, og pletter behandles lokalt; træ tørres af for støv og behandles som et møbel.

## Pris og leveringstid

Pr. kvadratmeter er PET-filt den økonomiske af de to og finértræ premiumproduktet; bed om et tilbud med dit areal. Priserne er ekskl. moms, og transport uden for Belgien, også til Danmark, tilbydes særskilt. Leveringstider fra egen produktion:

- **rPET Groove**: cirka 3–4 arbejdsuger; specialfarver på forespørgsel.
...
| Hurtigst levering | rPET Groove i lagerfarver, eller rWood Micro / Perf i lagerfinérer (cirka 3–4 uger) |

Stadig i tvivl? Bestil det gratis prøvesæt, og sammenlign begge materialer i selve rummet. De opkald, der stadig forstyrrer etagen, når panelerne er oppe, er en opgave for en [telefonboks til kontoret](/da/products/acoustic-phone-booths), ikke for mere filt.
...
**Hvilket panel er det mest bæredygtige valg?**
rPET Groove er fremstillet udelukkende af genanvendt PET og er OEKO-TEX Standard 100-certificeret; rWood bruger kun FSC-certificerede finérer. Begge laves på vores egen fabrik i Częstochowa. Gratis tilbagetagning tilbyder vi i BE, NL, FR, DE og LU, ikke i Danmark. Genanvendt indhold: rPET. Fornybar overflade: rWood.

*Kilder: ISO 11654 (lydabsorptionsklasser); ASTM C423 (NRC); EN 13501-1 (brandklasser); ISO 22955 som pejlemærke; DS 490 (dansk standard); W.C. Sabine (efterklangsformel); OEKO-TEX Standard 100; FSC; produktdata og testrapporter for Re-Sound rPET og rWood.*
