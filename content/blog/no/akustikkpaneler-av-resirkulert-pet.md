...
heroAlt: "Akustikkpanelet rPET Groove i grå resirkulert PET-filt, nærbilde av sporene og filtkanten"
...
## Hva er et akustikkpanel av resirkulert PET?
...
Lyden trenger inn i filten, setter fibrene i bevegelse og mister energien sin der gjennom friksjon. Hele flaten arbeider, kanter og bakside inkludert. Verdiene for 12 mm rPET Panel (EN ISO 354; αw og klasse etter ISO 11654):

| Montering | αw | Klasse |
|---|---|---|
| Rett på veggen | 0,25 | D |
...
## Hvor mange m² trenger du? Et regneeksempel etter Sabine

Ta et klasserom på 8 × 7 m med 3,2 m takhøyde, altså **179 m³**, med flisgulv, gipshimling og en glassvegg. Målt etterklangstid: **1,2 s**. Som referanse for målet bruker vi metoden i den tyske standarden DIN 18041, som plasserer undervisnings- og møterom i kategorien A3 «undervisning/kommunikasjon» med målverdien T = 0,32 · lg(V) − 0,17 s; for et norsk skolebygg er NS 8175 standarden, så sjekk det nøyaktige kravet med akustikeren din.

- T mål = 0,32 × lg(179) − 0,17 = 0,32 × 2,25 − 0,17 = 0,72 − 0,17 = **0,55 s**

Sabines formel gir deretter absorpsjonen som trengs: **A = 0,161 × V / T**.

- A i dag = 0,161 × 179 / 1,2 = **24,0 m² Sabine**
- A mål = 0,161 × 179 / 0,55 = **52,4 m² Sabine**
- Må tilføres: 52,4 − 24,0 = **28,4 m² Sabine**

Bare med rPET Panel 12 mm på 100 mm luftspalte (αw 0,80, klasse B) på veggene blir det 28,4 / 0,80 = **35,5 m² paneler**, altså 11 plater på 2.800 × 1.220 mm (11 × 3,42 = 37,6 m²). Mer praktisk er kombinasjonen: **30 m² absorberende himling** i klasse A (antatt αw 0,9; for eksempel en [akustisk strekkhimling](https://stretchplafond.be/products/acoustic-stretch-system) fra søsterselskapet vårt STRETCH) gir 30 × 0,9 = 27,0 m² Sabine, pluss **to plater rPET Panel** på 100 mm luftspalte på bakveggen (2 × 3,42 = 6,84 m² × 0,80 = 5,5 m² Sabine). Til sammen 32,5 m² Sabine, mer enn de 28,4 som trengs; rommet ender på 0,161 × 179 / (24,0 + 32,5) = **0,51 s**.

Paneler demper etterklangen, ikke telefonsamtalen som bærer gjennom kontorlandskapet. Til det trenger du en [telefonboks](/no/products/acoustic-phone-booths) som [Solo Flex](/no/products/solo-flex), fra {{price:solo-flex}} eks. mva. uten montering; montering av teamet vårt {{price:article:WEB-SOLO-FLEX-INST}}, transport på det europeiske fastlandet {{price:article:WEB-SOLO-FLEX-TRANSPORT-EU}}, begge eks. mva.
...
**Montering** skjer med lim, Z-klips, skruer eller på lekter:

- **Klips og skruer**: panelet kan tas ned og brukes om igjen, ideelt for leide lokaler og for en senere retur.
- **Lim**: for den permanente monteringen på et plant, rent og bæredyktig underlag.

Ved endt levetid er panelet ett materiale og kan resirkuleres. Den gratis returordningen vår gjelder i Belgia, Nederland, Frankrike, Tyskland og Luxembourg, ikke i Norge; mer under [bærekraft](/no/sustainability).

## Leveringstid og pris: hvor står PET i forhold til tre?

Leveringstider fra fabrikk:

- **rPET Groove**: omtrent 3–4 arbeidsuker; spesialfarger på forespørsel.
...
## PET eller tre: sammenligning og beslutningstabell

| Kriterium | rPET | rWood |
|---|---|---|
| Absorpsjon αw (ISO 11654) | rPET Panel 12 mm: 0,80, klasse B på 100 mm luftspalte; 1,00, klasse A på 50 mm luftspalte med 50 mm steinull | rWood Groove: 0,90, klasse A; rWood Micro: 0,90, klasse A, opptil 1,00 med 50 mm mineralull |
| NRC | rPET Groove: 0,55 / 0,75 / 0,90 ved 12 / 24 / 36 mm | ikke publisert |
| Reaksjon på brann (EN 13501-1) | B-s1,d0 i hvitt, grått og svart; B-s2,d0 i de andre fargene | rWood Groove: B-s1,d0 med FR-MDF-kjerne, D-s2,d2 med standard MDF-kjerne; rWood Micro: B-s1,d0 (FR-MDF-kjerne) |
| Materiale | bare resirkulert PET, OEKO-TEX Standard 100 | utelukkende FSC-sertifisert finer |
| Overflater | ti lagerfarger, alle farger på bestilling, kan males, UV-trykk | finertyper |
| Bearbeiding på stedet | kniv, sag, vinkelsliper | planlegges på forhånd (finer) |
| Pris per m² | på forespørsel; under tre | på forespørsel; premium |

Og som kortversjon:

| Din situasjon | Anbefaling |
|---|---|
| Farge, grafikk, logo, skilting | rPET Groove / rPET Panel |
| Egen bearbeiding i møbler, disker, skillevegger | rPET Panel |
| B-s1,d0 i skole eller offentlig bygg | rPET i hvitt, grått eller svart, [rWood Micro](/no/products/rwood-micro) eller rWood Groove med FR-MDF-kjerne |
| Representativt rom, resepsjon, tremøbler | rWood Groove / rWood Micro |
| Høyest resirkulert innhold | rPET (bare resirkulert PET) |
| Klasse A påkrevd | rPET Panel på 50 mm luftspalte med 50 mm steinull (αw 1,00), rWood Groove / rWood Micro (αw 0,90) eller Interior (αw 1,0) |
| Kort leveringstid, stort areal, stramt budsjett | rPET |

Ofte er svaret begge deler: tre på veggen folk ser på, PET alle andre steder. Sammenlign med [akustikkpanelene våre i tre](/no/products/wood-acoustic-panels), og be så om rPET-prøvesettet eller et tilbud per m²: [kontakt](/no/contact).

## Ofte stilte spørsmål

**Absorberer et akustikkpanel av resirkulert PET like godt som ett i tre?**
...
*Kilder: ISO 11654 (lydabsorpsjonsklasser); EN 13501-1 (reaksjon på brann); OEKO-TEX Standard 100; FSC; W.C. Sabine (etterklangsformel); DIN 18041 (den tyske standardens metode, brukt som referanse); ISO 22955; NS 8175 (norsk referanse); datablad og testrapporter fra Re-Sound for rPET og rWood.*
