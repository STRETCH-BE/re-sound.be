---
id: "BP-010"
slug: "panneau-acoustique-bois-microperfore"
locale: "fr"
title: "Panneau acoustique bois microperforé : fonctionnement | Re-Sound"
description: "Panneau acoustique en bois microperforé : perforations, lame d'air et absorbant arrière expliqués. rWood Micro ou Groove, placages FSC, feu B-s1,d0."
h1: "Panneaux acoustiques en bois microperforé : comment ça marche"
keyword: "panneau acoustique bois microperforé"
secondaryKeywords: ["panneau acoustique bois micro-perforé","absorbeur résonant microperforé","panneau acoustique placage bois","panneau bois perforé acoustique"]
intent: "learn"
category: "education"
...
Un panneau de bois plein réfléchit le son. Pour l'absorber, il lui faut un volume d'air et un moyen de dissiper l'énergie :
...
| Local | Ce que le bois microperforé apporte | Repère normatif |
|---|---|---|
| Bureaux et salles de réunion | Surface bois continue en réception, direction et salle du conseil | ISO 22955 et ISO 3382-3 (bureaux ouverts) |
| Restaurants et cafés | Chaleur du bois derrière les banquettes, B-s1,d0 | Objectif fixé avec l'acousticien |
| Écoles et auditoriums | Mur du fond absorbant, B-s1,d0 | NBN S 01-400-2 (écoles, Belgique) |
...
Salle de restaurant de 15 × 10 m sous 3,5 m de plafond, soit **525 m³**, sol carrelé et grandes baies vitrées. Réverbération mesurée à vide : **1,4 s**. Objectif : **0,7 s**. La formule de Sabine donne l'absorption nécessaire : **A = 0,161 × V / T**.
...
Nos [revendeurs](/fr/where-to-buy) et notre salle d'exposition de Beveren-Waas (sur rendez-vous) vous montrent les échantillons ; pour un devis au m², envoyez vos plans via la page [contact](/fr/contact).
...
**Quand choisir le bois microperforé plutôt que le feutre PET ?**
Quand l'aspect prime : réception, salle de direction, restaurant, auditorium ou école avec exigence B-s1,d0, le rWood Micro offre une surface bois presque continue en placage certifié FSC. Le feutre rPET reste le choix pour la couleur, le budget sur grande surface et les découpes sur chantier. Souvent, on combine : bois sur le mur que l'on regarde, rPET ailleurs.
