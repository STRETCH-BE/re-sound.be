---
id: "BP-booth-prices-is"
slug: "simaklefar-skrifstofu-verd-og-flokkar"
locale: "is"
title: "Símaklefar fyrir skrifstofur: verð og ISO 23351-1 flokkar | Re-Sound"
description: "Verð á símaklefa fyrir skrifstofu: Solo Flex frá {{price:solo-flex}} án VSK. Flokkar ISO 23351-1, loftræsting og staðsetning, beint frá framleiðanda."
h1: "Verð á símaklefum fyrir skrifstofur og flokkar ISO 23351-1 útskýrðir (2026)"
keyword: "símaklefi skrifstofa verð"
secondaryKeywords: ["hljóðeinangraður símaklefi verð","símaklefi fyrir skrifstofu kostnaður","fundarklefi verð","næðisklefi skrifstofa"]
intent: "compare"
category: "products"
...
heroAlt: "Solo Flex símaklefi fyrir einn frá Re-Sound í opnu skrifstofurými"
...
|---|---|---|
| Solo ECO | Re-Sound | {{price:solo-eco}} án uppsetningar |
| Solo Flex | Re-Sound | {{price:solo-flex}} án uppsetningar |
| Klefi fyrir einn | Keppinautur 1 | 2.990 € nettó |
...
Solo Flex lendir á milli keppinauta 2 og 3 í þessum samanburði, Solo ECO undir keppinauti 1; við smíðum klefana sjálf. Re-Sound er vörumerki Stretch Group og á verksmiðjurnar sjálft, í Beveren-Waas (Belgíu) og Częstochowa (Póllandi); símaklefarnir koma úr verksmiðjunni í Częstochowa.
...
**Solo ECO, {{price:solo-eco}} án VSK:**

- **1,1 m² gólfflötur**: 105 × 108 cm að utanmáli, 208 cm hár.
- **Fast standborð** 95 × 30 cm í 105 cm hæð.
- **Einn 230 V tengill** með USB-A og USB-C.
- **Loftræsting allt að 4 m³/mín**; 22 W í notkun, 2 W í biðstöðu.
- **8 mm glerungshúðað hljóðgler**, drapplitað filt að innan, hvítt (RAL 9016) að utan; lokaður bakveggur er staðalbúnaður, glerbakveggur valkostur.
- **Fimm ára ábyrgð** á varahlutum.

**Solo Flex, {{price:solo-flex}} án VSK:**

- **1 m² gólfflötur**: 102 × 102 cm, 226 cm hár.
- **Innbyggt sitja/standa-borð**: þú talar sitjandi eða standandi.
- **Loftræsting með fjórum EC-viftum**, 4,6 m³ af lofti á mínútu, stýrt af PIR-hreyfiskynjara.
- **230 V tengill, USB-C (60 W) og USB-A** inni í klefanum.
...
Talan sem skiptir máli fyrir hljóðeinangraðan símaklefa er **taldeyfing hans samkvæmt ISO 23351-1** í dB(A): hve miklu lægra tal er fyrir utan en innan. Flokkarnir:

| Flokkur | Taldeyfing | Í reynd |
|---|---|---|
| A+ | ≥ 33 dB | heyrist ekki utan klefans |
| A | ≥ 30 dB | varla heyranlegt |
| B | ≥ 27 dB | dempað muldur, ekki skiljanlegt |
| C | ≥ 24 dB | fjarlægt muldur, ekki skiljanlegt |
| D | ≥ 21 dB | heyranlegt, brot skiljanleg |

**Solo Flex nær um 24 dB(A), flokki C; Modular XL 25,9 dB(A), einnig flokki C.** Fyrir símtöl og myndfundi í opnu skrifstofurými leysir það vandann: samstarfsfólk heyrir fjarlægt muldur en engin orð. Fyrir Solo ECO og Duo hefur engin ISO 23351-1 mæling verið birt enn; við gefum gildið upp þegar mæliskýrslan liggur fyrir. Fyrir trúnaðarfundi rétt við annasamt gólf skaltu velja hærri flokk eða lokað herbergi og athuga nákvæmu kröfuna hjá hljóðvistarráðgjafanum þínum.

Biddu hvern söluaðila um prófunarskýrsluna samkvæmt ISO 23351-1.
...
5. **Staðsetning**: nálægt fólkinu sem hringir mest, ekki við kaffihornið eða á gönguleið.
6. **Flutningur síðar**: klefinn er settur saman á staðnum, tekinn í sundur eins og einingasett og fluttur á aðra hæð eða í annað hús.
