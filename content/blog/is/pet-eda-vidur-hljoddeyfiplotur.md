---
id: "BP-pet-vs-wood-is"
slug: "pet-eda-vidur-hljoddeyfiplotur"
locale: "is"
...
heroAlt: "Grá rPET Groove filtplata við hlið rWood Groove plötu með viðarspæni, nærmynd af rifunum"
...
|---|---|---|---|
| Hljóðísog αw (ISO 11654) | 0,80 (B) á 100 mm loftbili · 1,00 (A) á 50 mm loftbili og 50 mm steinull | 0,90 (A) | 0,90 (A), allt að 1,00 með 50 mm steinull í holrúminu |
...
Í opinberum byggingum er brunaflokkur samkvæmt EN 13501-1 oft ófrávíkjanleg krafa; athugaðu nákvæmu kröfuna hjá hljóðvistarráðgjafanum þínum eða brunahönnuði.

- **rPET-línan**: B-s1,d0 fyrir hvítt, grátt og svart, B-s2,d0 fyrir hina litina; flokkurinn fylgir litnum, jafnt í Standard- og FR-útgáfu. B-s1,d0 merkir takmarkað framlag til bruna, litla reykmyndun og enga logandi dropa.
...
**Viðhald**: PET er ryksugað og blettir hreinsaðir staðbundið; viður er þurrkaður af og meðhöndlaður eins og húsgögn.
...
- **rWood Micro og rWood Perf**: lagerspænir á 3–4 vikum; aðrir spænir 6–8 vikur.

Re-Sound er vörumerki Stretch Group. Verksmiðjurnar tvær, í Beveren-Waas (Belgíu) og Częstochowa (Póllandi), eru okkar eigin: rPET og rWood koma frá Częstochowa, textíllínan frá Beveren-Waas, þar sem þú getur séð bæði efnin í sýningarsalnum eftir bókun. Sjá [hvar er hægt að kaupa](/is/where-to-buy) eða notaðu [tengiliðasíðuna](/is/contact).

## Ákvörðunartafla: hvenær PET, hvenær viður

| Þín staða | Veldu |
|---|---|
| Litur, grafík, merki, sérprentun með UV | rPET Groove / rPET Panel |
| Bogadregnir veggir og súlur | rPET Flex Groove |
| Skurður og aðlögun á staðnum, sérsmíði | [rPET Panel](/is/products/rpet-panel) |
| Krafa um brunaflokk B-s1,d0 í opinberri byggingu | rPET í hvítu, gráu eða svörtu, eða rWood á FR MDF-kjarna |
| Stjórnarherbergi, móttaka, veitingastaður, viðarinnrétting | rWood Groove / rWood Panel |
| Hæsta hlutfall endurunnins efnis | rPET (alfarið úr endurunnu PET) |
