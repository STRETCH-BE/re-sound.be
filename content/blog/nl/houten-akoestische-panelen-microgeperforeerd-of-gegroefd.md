---
id: "BP-wood-micro-vs-grooved-nl"
slug: "houten-akoestische-panelen-microgeperforeerd-of-gegroefd"
locale: "nl"
title: "Houten akoestische panelen: microgeperforeerd of gegroefd? | Re-Sound"
description: "Microgeperforeerd of gegroefd hout? Beide αw 0,90, klasse A; rWood Micro met minerale wol tot 1,00. Opbouw, FSC-fineer, brandklasse en levertijd vergeleken."
h1: "Houten akoestische panelen: kies je microgeperforeerd of gegroefd?"
keyword: "houten akoestische panelen microgeperforeerd of gegroefd"
secondaryKeywords: ["microgeperforeerde akoestische panelen hout","gegroefde akoestische panelen hout","akoestisch paneel houtfineer fsc","houten akoestische panelen brandklasse"]
intent: "compare"
category: "education"
...
**Microgeperforeerde en gegroefde houten akoestische panelen doen akoestisch hetzelfde werk: rWood Groove en rWood Micro halen allebei αw 0,90, klasse A volgens ISO 11654, en rWood Micro klimt met 50 mm minerale wol in de spouw tot αw 1,00. Je kiest dus op opbouw, uitzicht, brandklasse, levertijd en budget.** In deze gids zetten we [rWood Groove](/nl/products/rwood-groove) (gegroefd) en [rWood Micro](/nl/products/rwood-micro) (microgeperforeerd) naast elkaar, met een rekenvoorbeeld volgens Sabine en een beslistabel.
...
**Microgeperforeerd (rWood Micro).** Hier blijft het vlak bijna dicht. Alleen een fijne perforatie (gaatjes vanaf Ø 0,5 mm, in vier dichtheden tot Ø 2 mm) laat het geluid door naar een brandvertragende MDF-kern met geluidskamers en naar het akoestische vlies, zwart of wit, aan de achterzijde. Ook zo kom je op **αw 0,90, klasse A**; met 50 mm minerale wol in de spouw achter het paneel loopt dat op **tot αw 1,00**. De precieze waarde hangt af van de perforatiedichtheid, de diepte van de spouw en de absorber erachter. rWood Micro maken we op maat tot 3.050 × 1.220 mm, in 10 en 19 mm.

## De vraag die telt: wat zit er achter het paneel?
...
Een vergaderzaal van 5 × 4 m en 2,8 m hoog meet **56 m³**. Tapijttegels, zes gestoffeerde stoelen, een glazen wand; gemeten nagalmtijd **0,9 s**. Als referentie nemen we de methode van de Duitse norm DIN 18041, die vergaderruimtes in groep A3 (onderwijs en communicatie) onderbrengt en daarvoor de streefwaarde T_soll = 0,32 × lg(V) − 0,17 (in seconden) hanteert; voor open kantoren vul je dat aan met ISO 22955. De formule van Sabine, **A = 0,161 × V / T**, geeft dan de absorptie die erbij moet:

| Stap | Rekening | Resultaat |
|---|---|---|
| Streefwaarde (methode DIN 18041, groep A3) | 0,32 × lg(56) − 0,17 = 0,32 × 1,75 − 0,17 | **0,39 s** |
| Absorptie vandaag | 0,161 × 56 / 0,9 | **10,0 m² sabine** |
| Absorptie bij 0,39 s | 0,161 × 56 / 0,39 | **23,1 m² sabine** |
| Erbij | 23,1 − 10,0 | **13,1 m² sabine** |

Met rWood Groove of rWood Micro (allebei αw 0,90) komt dat neer op 13,1 / 0,90 = **14,6 m² paneel**: de lange wand tegenover het scherm (5 × 2,8 = 14,0 m²) plus een strook van 0,6 m² op de korte wand achter de sprekers. Kies je rWood Micro met 50 mm minerale wol in de spouw (αw 1,00), dan volstaat 13,1 m², en dan is de lange wand alleen al genoeg. Check de exacte eis voor jouw zaal bij je akoesticus.

Panelen halen de galm uit de zaal, maar houden het telefoongesprek dat over een open vloer draagt niet tegen. Daarvoor is er de [belcabine](/nl/products/akoestische-belcabines), zoals onze [Solo Flex](/nl/products/solo-flex): vanaf {{price:solo-flex}} excl. btw zonder plaatsing; laat je ze door ons team plaatsen, dan komt daar {{price:article:WEB-SOLO-FLEX-INST}} bij, en voor het transport binnen het Europese vasteland {{price:article:WEB-SOLO-FLEX-TRANSPORT-EU}}, telkens excl. btw.
...
## Beslistabel: wanneer gegroefd, wanneer microgeperforeerd

| Criterium | rWood Groove (gegroefd) | rWood Micro (microgeperforeerd) |
|---|---|---|
| Absorptie αw (ISO 11654) | 0,90, klasse A, met eigen 3 mm rPET-vilt op de rug | 0,90, klasse A; met 50 mm minerale wol in de spouw tot 1,00 |
...
|---|---|
| Dunne opbouw, rechtstreeks op de ondergrond verlijmd | rWood Groove |
| Rustig houtvlak, gelijk met deuren en inbouwkasten | rWood Micro |
| B-s1,d0 in een school, overheidsgebouw of zaal | rWood Micro, of rWood Groove op de brandvertragende MDF-kern |
| Toch al een draagstructuur met spouw gepland | allebei; rWood Micro met 50 mm minerale wol tot αw 1,00 |
| Kortste levertijd | rWood Micro in een voorraadfineer (3 à 4 weken); rWood Groove volgens voorraad |
| Krap budget, groot oppervlak | hout op de zichtwand, rPET-panelen op de rest |

Nog niet beslist? Het rWood-stalenpakket bevat beide uitvoeringen; leg ze in je eigen ruimte in het daglicht en de keuze valt meestal vanzelf.

## Veelgestelde vragen

**Absorbeert een microgeperforeerd houten paneel minder goed dan een gegroefd?**
Nee. Volgens hun datasheets halen beide αw 0,90, klasse A volgens ISO 11654: rWood Groove dankzij het 3 mm rPET-vilt op zijn rug, rWood Micro dankzij het akoestische vlies en de spouw achter het paneel. Leg je 50 mm minerale wol in die spouw, dan stijgt rWood Micro tot αw 1,00. Kies dus op opbouw, uitzicht, brandklasse, levertijd en budget, niet op absorptieklasse.

**Welke absorber hoort er achter een houten akoestisch paneel?**
Geen enkele is verplicht: beide reeksen halen klasse A zonder extra absorber. rWood Micro hangt op aluminium rails voor een spouw waarin je naar keuze 50 mm minerale wol legt, goed voor αw 1,00. Bij rWood Groove op latten kan de spouw akoestisch vilt, een rPET Panel of minerale wol krijgen; dat rPET Panel bestaat volledig uit gerecycleerd PET, is in wit, grijs en zwart B-s1,d0 en in de andere kleuren B-s2,d0 (EN 13501-1) en snij je op de werf met een mes of een zaag. Welke combinatie jouw ruimte nodig heeft, volgt uit de nagalmtijd die je moet halen; check de exacte eis bij je akoesticus.
