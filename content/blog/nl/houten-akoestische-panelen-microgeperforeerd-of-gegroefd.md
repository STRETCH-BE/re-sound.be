...
description: "Microgeperforeerd of gegroefd hout? Beide αw 0,90, klasse A; rWood Micro met minerale wol tot 1,00. Opbouw, FSC-fineer, brandklasse en levertijd."
...
Een vergaderzaal van 5 × 4 m en 2,8 m hoog meet **56 m³**. Tapijttegels, zes gestoffeerde stoelen, een glazen wand; gemeten nagalmtijd **0,9 s**. Als referentie nemen we de rekenmethode uit de Duitse norm DIN 18041, die vergaderruimtes bij groep A3 (onderwijs en communicatie) indeelt en daarvoor de streefwaarde T_soll = 0,32 × lg(V) − 0,17 (in seconden) hanteert; voor open kantoren vul je dat aan met ISO 22955. Sabine (**A = 0,161 × V / T**) geeft dan de absorptie die erbij moet:
...
Met rWood Groove of rWood Micro (allebei αw 0,90) komt dat neer op 13,1 / 0,90 = **14,6 m² paneel**: de lange wand tegenover het scherm (5 × 2,8 = 14,0 m²) plus een strook van 0,6 m² op de korte wand achter de sprekers. Kies je rWood Micro met 50 mm minerale wol erachter (αw 1,00), dan volstaat 13,1 m², en dan is de lange wand alleen al genoeg. Check de exacte eis voor jouw zaal bij je akoesticus.

Panelen halen de galm uit de zaal, maar houden het telefoongesprek dat over een open vloer draagt niet tegen. Daarvoor is er de [belcabine](/nl/products/akoestische-belcabines), zoals onze [Solo Flex](/nl/products/solo-flex), die vanaf {{price:solo-flex}} excl. btw kost zonder transport en plaatsing; laat je ze door ons team plaatsen, dan komt daar {{price:article:WEB-SOLO-FLEX-INST}} bij, en voor het transport op het Europese vasteland {{price:article:WEB-SOLO-FLEX-TRANSPORT-EU}}, beide excl. btw.
